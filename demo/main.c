...
static void test_window(mu_Context *ctx)
{
  ...
  if (mu_begin_window(ctx, "Demo Window", mu_rect(40, 40, 300, 450)))
  {
    ...
    /* progress bars */
    if (mu_header(ctx, "Progrss Bars"))
    {
      mu_progress_bar(ctx, 0, 0, 100);
      mu_progress_bar(ctx, 10, 0, 100);
      mu_progress_bar(ctx, 25, 0, 100);
      mu_progress_bar(ctx, 50, 0, 100);
      mu_progress_bar(ctx, 75, 0, 100);
      mu_progress_bar(ctx, 90, 0, 100);
      mu_progress_bar(ctx, 100, 0, 100);
    }
